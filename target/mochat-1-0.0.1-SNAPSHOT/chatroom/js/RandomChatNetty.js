(function($,undefined){
   ...
   var  messageaction = function (message) {
    ...
    var sendMsg = function(){
		            ...
		            var data = {"msg":txt,"userId":userId,"toUserId":toUserId};
		 ...
		 initWebSocket = function(param){
			   ...
			   if ('WebSocket' in window) {
			       // websocket = new WebSocket("ws://"+baseUrl(1).split(":")[0]+":7397/"+"websocket/socketServer.do?"+param);
			        websocket = new WebSocket("ws://"+baseUrl(1).split(":")[0]+"/websocket?"+param); 
			    }else if ('MozWebSocket' in window) {
			        websocket = new MozWebSocket("ws://"+baseUrl(1).split(":")[0]+"websocket/socketServer.do?"+param);
			    } 
			    else {
